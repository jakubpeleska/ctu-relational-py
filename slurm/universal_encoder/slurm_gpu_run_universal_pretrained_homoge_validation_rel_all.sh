...
run_name="${EXPERIMENT_ID}_${pretrain_dataset}_${eval_dataset}_${task}"
log_dir="logs/${EXPERIMENT_ID}/${pretrain_dataset}/${eval_dataset}_${task}"
mkdir -p "$log_dir"
