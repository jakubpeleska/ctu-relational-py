...
#SBATCH --job-name=universal_pretrained_homoge_abla_validation
#SBATCH --gres=gpu:1
...
EXPERIMENT_NAME="universal_pretrained_homoge_abla_validation"
...
CHECKPOINTS=()
for tablayers in 1 2 4; do
    CHECKPOINT_NAME="${pretrain_dataset}_tablayers${tablayers}_homoge_abla.pt"
