...
#SBATCH --job-name=universal_pretrained_homogeneous_ablations
#SBATCH --gres=gpu:1
...
EXPERIMENT_NAME="universal_pretrained_homogeneous_ablations"
...
python -u experiments/universal_encoder/universal_encoder_pretrained.py \
  ...
  --num_samples=${NUM_SAMPLES} --no_stats_emb --no_stype_emb --no_name_emb \
