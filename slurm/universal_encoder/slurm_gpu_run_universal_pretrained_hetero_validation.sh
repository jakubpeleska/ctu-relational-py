...
#SBATCH --job-name=universal_pretrained_hetero_validation
#SBATCH --gres=gpu:1
...
EXPERIMENT_NAME="universal_pretrained_hetero_validation"
...
for tablayers in 1 2 4; do
    CHECKPOINT_NAME="${pretrain_dataset}_tablayers${tablayers}_hetero.pt"
